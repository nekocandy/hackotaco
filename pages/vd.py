...
vd_arr = [
    "https://www.youtube.com/watch?v=mi9t8usEM3g&list=PLPDgudJ_VDUcgpSq_T1NdXaevNLawrOGo&index=1&pp=iAQB",
...
with col2:
    st.markdown(
        "[**Codecademy Python Course (Free version)**](https://www.codecademy.com/learn/learn-python-3)"
    )

    st.markdown("[**Solo learn**](https://www.sololearn.com/Course/Python/)")

    st.markdown(
        "[**JetBrains Academy Python Track (Free version)**](https://hyperskill.org/tracks/2)"
    )
